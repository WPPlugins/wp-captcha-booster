...
if (!is_user_logged_in()) {
   ...
   if (!$access_granted) {
      ...
      /*
        Class Name: plugin_info_captcha_booster
        Parameters: No
        Description: This Class is used to get the the information about plugins.
        Created On: 12-04-2017 17:06
        Created By: Tech Banker Team
       */

      class plugin_info_captcha_booster {
         /*
           Function Name: get_plugin_info_captcha_booster
           Parameters: No
         ...
         function get_plugin_info_captcha_booster() {
