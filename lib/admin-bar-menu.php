   ...
   if (!$access_granted) {
      ...
      if ($flag == "1") {
         $wp_admin_bar->add_menu(array
             ...
             "\" width=\"16\" height=\"16\" style=\"vertical-align:text-top; margin-right:5px;\"./> $cpb_captcha_booster_breadcrumb",
         ...
         $wp_admin_bar->add_menu(array
             (
             "parent" => "captcha_booster",
             "id" => "cpb_feature_requests",
             "title" => $cpb_feature_requests,
             "href" => admin_url("admin.php?page=cpb_feature_requests")
         ));
         $wp_admin_bar->add_menu(array
             (
             "parent" => "captcha_booster",
         ...
         $wp_admin_bar->add_menu(array
             ...
             "title" => $cpb_upgrade,
             "href" => admin_url("admin.php?page=cpb_premium_editions")
         ));
      }
   }
}